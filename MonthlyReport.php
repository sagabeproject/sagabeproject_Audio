<?php
 ...
 $stat = intval($_GET["status_id"]);

 //Change this query as you wish for single or multiple records
 $result = mysql_query("SELECT count( * ) AS total, MONTH( dte_update ) AS MONTH FROM audio_process_master WHERE status_id = ".$stat." GROUP BY MONTH( dte_update );");
