<?php
 ...
 $result = mysql_query("SELECT status_desc, count(*) from audio_status_lookup as a INNER JOIN audio_process_master as b ON a.status_id=b.status_id GROUP BY b.status_id");
